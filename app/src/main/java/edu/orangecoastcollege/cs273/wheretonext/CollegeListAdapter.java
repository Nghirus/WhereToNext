...
public class CollegeListAdapter extends ArrayAdapter<College> {
    ...
    public View getView(int pos, View convertView, ViewGroup parent)
    {
        ...
        ImageView itemImageView = (ImageView) view.findViewById(R.id.listImageView);
        TextView itemTextView = (TextView) view.findViewById(R.id.listCollegeNameTextView);
        RatingBar itemRatingBar = (RatingBar) view.findViewById(R.id.listRatingBar);
        ...
        itemTextView.setText(selectedCollege.getName());
        itemRatingBar.setRating((float) selectedCollege.getRating());
